...
export const guideFeatureCards = [
  {
    ...
    mockRows: [
      ...
      { label: 'Mohamed B.', value: 'Absent', tone: 'gold', dot: 'go' },
      { label: 'Amina R.', value: 'SOS', tone: 'blue', dot: 'bl' },
    ],
  },
  {
    tag: 'Mobile - Famille',
    title: 'Suivre les etapes de votre proche',
    text: "Visualisez l'etape actuelle, la prochaine action et les evenements du jour pour mieux suivre votre proche.",
    ghost: 'P',
    mockRows: [
      { type: 'detailTag', icon: 'calendar', iconColor: '#B8962E', label: 'Depart vers Mina', detail: 'Dans 25 minutes', value: 'en cours', tone: 'gold' },
    ],
  },
  {
    tag: 'Mobile - Guides',
    title: 'Presence et situations urgentes',
    text: "Lancez un appel de presence, recevez les confirmations et intervenir rapidement un incident est déclenché si necessaire.",
    ghost: 'U',
    mockRows: [
      { icon: 'users', iconColor: '#2D7A4A', label: 'Appel de presence' },
      { icon: 'alert', iconColor: '#e53e3e', label: 'Résoudre une Alerte' },
    ],
  },
  {
    tag: 'Mobile - Pèlerins',
    title: 'Alertes et echanges',
    text: "Recevez des notifications ,suivez votre planning et signalez une urgence en quelques clics.",
    ghost: 'C',
    mockRows: [
      { type: 'detailValue', icon: 'mail', iconColor: '#6A6560', label: 'Départ vers Mina', detail: 'Rendez-vous a 14h a la porte 1', value: '09:00' },
      { type: 'detailValue', icon: 'mail', iconColor: '#6A6560', label: 'Groupe G-07', value: '08:42' },
    ],
  },
]
